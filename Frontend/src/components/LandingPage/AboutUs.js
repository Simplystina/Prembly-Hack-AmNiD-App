...
const AboutUs = () => {
  return (
    <Flex p={["20px 20px","20px 40px","30px 60px"]} w="100%" justifyContent="space-between" alignItems="center" flexDir={["column","column","row"]}>
        <Box w={["100%",null,"50%"]} >
            <Img borderRadius="14px" objectFit="contain" w="100%" src="/images/about-us.png"/>
        </Box>
        <Box w={["100%",null,"45%"]}>
            <Text pt="15px" color="#2E2E2E" fontWeight="600" fontSize={["18px","22px","26px"]}>
            About AmNiD
            </Text>
            <Text p={["10px 0","20px 0"]} color="#747474" fontWeight={500} fontSize={["12px","16px"]} lineHeight={["25px","30px"]}>
            ...
            <Text color="#747474" fontWeight={500} fontSize={["12px","16px"]}lineHeight={["23px","34px"]}>
