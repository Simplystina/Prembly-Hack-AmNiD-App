...
const GetStarted = () => {
  return (
    <Box p={["20px 30px","20px 40px","30px 60px"]}  w="100%" >
        ...
        <Flex alignItems="center" w="100%" pt={["30px","50px","80px"]} direction={['column',null, 'row']}>
            <Box w={["100%",null,"50%"]}>
            ...
            <Box w={["100%",null,"50%"]} mt={[20,null,0]}>
                <Img src="/images/get-started.png"/>
            </Box>
        </Flex>
        <Flex alignItems="center" justifyContent="space-between" w="100%" pt="80px" direction={['column',null, 'row']}>
            <Box w={["100%",null,"50%"]}>
                <Img borderRadius={10} w="100%" src="/images/customers-pic.png"/>
            </Box>
            <Box w={["100%",null,"45%"]}>
                <Text color="#747474" fontWeight={600} fontSize={["18px","23px","28px"]} mb="20px">For Customers</Text>
                <Text color="#747474" fontWeight={500} fontSize= {["14px","16px","20px"]}lineHeight="30px" >
