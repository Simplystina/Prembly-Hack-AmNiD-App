...
const GetStarted = () => {
  return (
    <Box p="40px 60px" w="100%" >
        <Center mb="30px">
            <Button color="white"     bg="#008565" h="52px" w="300px"  borderRadius={6}>Get Started
            </Button>
        </Center>
        <Flex alignItems="center" w="100%" pt="80px">
            <Box w="50%">
                <Text color="#747474" fontWeight={500} fontSize="20px" lineHeight="30px" maxW="400px">
                ...
                <Button mt="40px" color="white"     bg="#008565" h="52px" w="300px"  borderRadius={6}>Get a Unique Key
            </Button>
            </Box>
            <Box w="50%">
        ...
        <Flex alignItems="center" justifyContent="space-between" w="100%" pt="80px">
            <Box w="50%">
                <Img borderRadius={10} w="100%" src="/images/customers-pic.png"/>
            </Box>
            <Box w="45%">
                <Text color="#747474" fontWeight={600} fontSize="28px" mb="20px">For Customers</Text>
                <Text color="#747474" fontWeight={500} fontSize="20px" lineHeight="30px" >
